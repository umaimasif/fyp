...
# Explicitly defined owners (10 Users Total)
owners_data = [
    {
        "nic": "35202-1234567-1",
        "name": "Ali Raza",
...
try:
    ...
    print("✅ Dummy Owners inserted successfully (10 Users Total).")
...
print("🎉 Database has been successfully set up with 10 predictable users!")